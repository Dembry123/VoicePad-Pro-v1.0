...
clf_svm = SVC()
clf_pipe = Pipeline([("SCL", StandardScaler()), ("SVC", SVC())])
...
coreml_model = coremltools.converters.sklearn.convert(clf_rf)
...
coreml_model = coremltools.converters.sklearn.convert(clf_pipe)

# save out as a file
coreml_model.save("PipeAccel.mlmodel")

coreml_model = coremltools.converters.sklearn.convert(clf_gb)
